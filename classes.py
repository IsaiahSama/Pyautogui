...
class MyClass:
    ...
    def main(self):
        ...
        while minutes < 510:
            print(f"Time is currently {time.ctime().split(' ')[3]}")
            time.sleep(40)
        ...
        for period in self.periods:
            ...
            if is_class:
                ...
                self.send_msg(f"Joined {current_class}")
                
            else:
                print("No class I guess")

            minutes = self.get_time()
            print(f"Time is {time.ctime().split(' ')[3]}")
    ...
    def send_msg(self, msg):
        ...
        time.sleep(3)
        text_area = pyautogui.locateOnScreen("images/msg.png")
        if text_area:
    ...
    def get_last(self, itera):
        ...
        for img in itera:
            ...
            numbers.append(int(re.findall(r"([0-9]+)", img.split(".")[0])))
    ...
    def screen_check(self, current_class):
        ...
        if sharing:
            ...
            if screenshots:
                ...
                highest = self.get_last(screenshots)
            else:
...
if not os.path.exists("jsondata/schedule1.json"):
    weekly_schedule = {}
    def setup(filename):
        for day in dotw:
            weekly_schedule[day] = {}
